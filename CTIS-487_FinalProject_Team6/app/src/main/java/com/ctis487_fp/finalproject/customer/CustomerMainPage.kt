...
class CustomerMainPage : AppCompatActivity() {
    ...
    private val selectedMedicines = mutableMapOf<String, Int>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = binding.customerview
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View?, position: Int, id: Long) {
                ...
                fetchMedicinesForSales(selectedSalesName)
            }
    ...
    private fun fetchMedicinesForSales(salesName: String) {
        ...
        salesDatabase.orderByChild("name").equalTo(salesName)
